# SAD-SINARM
Projeto da disciplina de Sistemas de Apoio a Decisão, usando Dados Abertos do SINARM(Sistema Nacional de Armas)
...
- **PostgreSQL** – Área de staging e DW  
- **Power BI** – Relatórios e modelo OLAP  
...
2. **Identificação das Fontes de Da**
3. **Definição da Abordagem Utiliza**
4. **Modelagem das Dimensões e Fato**
5. **Projeto Físico**
6. **ETL**
7. **OLAP**
